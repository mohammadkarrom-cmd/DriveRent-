# Generated by Django 5.0.4 on 2025-02-04 16:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, null=True, upload_to=users.models.PathAndRename('media/'))),
                ('image2', models.ImageField(blank=True, null=True, upload_to=users.models.PathAndRename('media/'))),
                ('image3', models.ImageField(blank=True, null=True, upload_to=users.models.PathAndRename('media/'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('manager', 'مدير'), ('employee', 'موظف'), ('customer', 'زبون')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_front_image', models.TextField()),
                ('id_back_image', models.TextField()),
                ('driving_license_image', models.TextField()),
