...
const CarsMangerContent = () => {
    const { data: response, error, mutate, isLoading } = useSWR(endpoints.customer.customerCars.list, fetchApi);
    ...
    return (
        <>
            <ManagementPageHeader
                ...
                actions={<AddCar mutate={mutate} categories={data.category_list} isCustomer/>}
            />
