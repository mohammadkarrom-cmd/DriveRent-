...
import AdminStaticCount from "./AdminStaticCount"
import CarCategoriesChart from "./charsts/CarCategoriesChart"
import CarsStatusChart from "./charsts/CarsStatusChart"
import IncomeChart from "./charsts/IncomeChart"
...
const AdminStatics = () => {
    ...
    return (
        <div>
            ...
            <IncomeChart
                chartData={incomeBar.chartData}
                total={incomeBar.total}
            />
            <ol
            ...
            >
                <li className="w-full 2xl:w-[48%]">
                    <CarsStatusChart
                        labels={carsStatus.labels}
                        series={carsStatus.series}
                    />
                </li>
                <li className="w-full 2xl:w-[48%]">
                    <CarCategoriesChart
                        categories={carsCategories.categories}
                        series={carsCategories.series}
                    />
                </li>
            </ol>
        </div>
